        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {contactInfo.map((info, i) => (
            <motion.div
              ...
              className="bg-card rounded-xl p-8 text-center border border-gray-200 hover:border-primary/50 transition-colors duration-300"
            >
              ...
              {info.lines.map((line, j) => (
                info.links ? (
                  ...
                  <p key={j} className="text-gray-500">{line}</p>
                )
              ))}
            </motion.div>
          ))}
