        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <div className="relative w-full h-[400px] md:h-[500px]">
              ...
              <div className="absolute -top-3 -left-3 w-20 h-20 border-t-4 border-l-4 border-primary z-10" />
              <div className="absolute -bottom-3 -right-3 w-20 h-20 border-b-4 border-r-4 border-primary z-10" />
              <Image
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {stats.map((stat, i) => (
                ...
                >
                  ...
                  <div className="text-dark font-bold text-sm">{stat.label}</div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {features.map((feature, i) => (
            <motion.div
              ...
              className="bg-card border border-gray-200 rounded-xl p-6 hover:border-primary/50 transition-colors duration-300"
            >
